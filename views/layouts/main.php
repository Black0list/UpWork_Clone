    ...
    <div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary">
        ...
        <nav class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light bg-white border-bottom border-bottom-lg-0 border-end-lg" id="navbarVertical">
            <div class="container-fluid">
                ...
                <!-- Brand -->
                <a class="navbar-brand d-flex align-items-center py-lg-2 mb-lg-5 px-lg-6 me-0" href="#">
    <div class="avatar-parent-child">
        <img src="https://api.dicebear.com/7.x/adventurer/svg?seed=JohnDoe" width="50" class="avatar rounded-circle  bg-light">
        <span class="avatar-child avatar-badge bg-success"></span>
    </div>
    <h3 class="mb-0 text-success">
        <span class="text-info"><?php echo htmlspecialchars($_SESSION['user']->getFirstname()); ?></span>
    </h3>
</a>
                ...
                <div class="collapse navbar-collapse" id="sidebarCollapse">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            <a class="nav-link text-danger" href="/auth/logout" onclick="return confirm('Are you sure you want to logout?')">
